...
| | `frontend/` (this doc) | [`docs/index.html`](./docs/README.md) | [`docs/apps-script-v0.5.html`](./docs/README.md) | [`apps-script/`](./apps-script/README.md) |
|---|---|---|---|---|
...
different ways. `docs/apps-script-v0.5.html` is a separate static UI that talks
...
(`main`, `/docs`), which serves `docs/index.html` and `docs/apps-script-v0.5.html`
