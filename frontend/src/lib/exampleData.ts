interface ExampleData {
  ...
  draws: { name: string; date: string; amount: number; source: string | null; sortOrder: number }[];
  capTable: {
    name: string;
    role: string;
    ownershipPercent: number | null;
    contributions: { date: string; amount: number; note: string | null }[];
    distributions: { date: string; amount: number; note: string | null }[];
  }[];
}
